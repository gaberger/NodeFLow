...
//
// module.exports.createServer = function(address, port, io) {
// 	if(false === (this instanceof Downloader)) {
// 	        return new Downloader();
//     var nc = new NodeFlow(io)
//     nc.Start(address, port, io)
//     return nc
// }
// NodeFlow.prototype = new process.EventEmitter();
    ...
    var server = net.createServer(function(socket) {
        ...
        function(data) {
            ...
            case 'OFPT_FEATURES_REPLY':
                ...
                break;
            case 'OFPT_PACKET_IN':
                // io.emit('OFPT_PACKET_IN', socket, mbuf)
                break;
